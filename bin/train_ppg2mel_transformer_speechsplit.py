...
from src.data_load import SpeechSplitCollate, Utterances
from src.transformer_speechsplit import Transformer
...
class Solver(BaseSolver):
    ...
    def load_data(self):
        ...
        train_dataset = Utterances(
            ...
            org_wav_dir = self.config.data.org_wav_dir,
        ...
        self.train_dataloader = DataLoader(
            ...
            pin_memory=False,
            drop_last=True,
            collate_fn=SpeechSplitCollate(n_frames_per_step=1,
    ...
    def exec(self):
        ...
        while self.step < self.max_step:
            for data in self.train_dataloader:
                ...
                total_loss = 0
                # data to device
                #(content_padded, pitch_padded, rhythm_padded, mels_padded, \
            #torch.LongTensor(ppg_lengths), torch.LongTensor(mel_lengths), timbre_input, stop_tokens)
                
                content, pitch, rhythm, mels, in_lengths, \
