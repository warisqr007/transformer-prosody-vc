...
#                 --name=transformer-vc-init-rr-spk-attn-II \
#                 --seed=2 \
#                 --transvcsplinpconc
...
python main.py  --config /mnt/data1/waris/repo/transformer-prosody-vc/conf/transformer_vc_speechsplit.yaml \
                --name=transformer-speechsplit \
                --seed=2 \
                --transformerspeechsplit